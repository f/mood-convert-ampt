...
var deserializeAws_json1_0BatchGetItemCommand = async (output, context) => {
  ...
  let contents = {};
  contents = deserializeAws_json1_0BatchGetItemOutput(data2, context);
  const response = {
...
var deserializeAws_json1_0BatchWriteItemCommand = async (output, context) => {
  ...
  const data2 = await parseBody(output.body, context);
  let contents = {};
  contents = deserializeAws_json1_0BatchWriteItemOutput(data2, context);
  const response = {
    $metadata: deserializeMetadata2(output),
    ...contents
  };
...
var deserializeAws_json1_0DeleteItemCommand = async (output, context) => {
  ...
  const data2 = await parseBody(output.body, context);
  let contents = {};
  contents = deserializeAws_json1_0DeleteItemOutput(data2, context);
  const response = {
    $metadata: deserializeMetadata2(output),
    ...contents
  };
...
var deserializeAws_json1_0DescribeEndpointsCommand = async (output, context) => {
  ...
  const data2 = await parseBody(output.body, context);
  let contents = {};
  contents = deserializeAws_json1_0DescribeEndpointsResponse(data2, context);
  const response = {
    $metadata: deserializeMetadata2(output),
    ...contents
  };
...
var deserializeAws_json1_0PutItemCommand = async (output, context) => {
  ...
  const data2 = await parseBody(output.body, context);
  let contents = {};
  contents = deserializeAws_json1_0PutItemOutput(data2, context);
  const response = {
    $metadata: deserializeMetadata2(output),
    ...contents
  };
...
var deserializeAws_json1_0QueryCommand = async (output, context) => {
  ...
  const data2 = await parseBody(output.body, context);
  let contents = {};
  contents = deserializeAws_json1_0QueryOutput(data2, context);
  const response = {
    $metadata: deserializeMetadata2(output),
    ...contents
  };
...
var deserializeAws_json1_0ScanCommand = async (output, context) => {
  ...
  const data2 = await parseBody(output.body, context);
  let contents = {};
  contents = deserializeAws_json1_0ScanOutput(data2, context);
  const response = {
    $metadata: deserializeMetadata2(output),
    ...contents
  };
...
var deserializeAws_json1_0UpdateItemCommand = async (output, context) => {
  ...
  const data2 = await parseBody(output.body, context);
  let contents = {};
  contents = deserializeAws_json1_0UpdateItemOutput(data2, context);
  const response = {
    $metadata: deserializeMetadata2(output),
    ...contents
  };
...
var deserializeAws_queryAssumeRoleCommand = async (output, context) => {
  ...
  let contents = {};
  contents = deserializeAws_queryAssumeRoleResponse(data2.AssumeRoleResult, context);
  const response = {
...
var deserializeAws_queryAssumeRoleWithWebIdentityCommand = async (output, context) => {
  ...
  const data2 = await parseBody2(output.body, context);
  let contents = {};
  contents = deserializeAws_queryAssumeRoleWithWebIdentityResponse(data2.AssumeRoleWithWebIdentityResult, context);
  const response = {
    $metadata: deserializeMetadata3(output),
    ...contents
  };
...
var deserializeAws_restJson1InvalidRequestExceptionResponse = async (parsedOutput, context) => {
  ...
  if (data2.message != null) {
    contents.message = expectString(data2.message);
  }
...
var deserializeAws_restJson1CreateTokenCommand = async (output, context) => {
  ...
  if (data2.accessToken != null) {
    contents.accessToken = expectString(data2.accessToken);
  }
  if (data2.expiresIn != null) {
    contents.expiresIn = expectInt32(data2.expiresIn);
  }
  if (data2.idToken != null) {
    contents.idToken = expectString(data2.idToken);
  }
  if (data2.refreshToken != null) {
    contents.refreshToken = expectString(data2.refreshToken);
  }
  if (data2.tokenType != null) {
    contents.tokenType = expectString(data2.tokenType);
  }
  return contents;
};
...
var deserializeAws_restJson1AccessDeniedExceptionResponse = async (parsedOutput, context) => {
  ...
  const data2 = parsedOutput.body;
  if (data2.error != null) {
    contents.error = expectString(data2.error);
  }
  if (data2.error_description != null) {
    contents.error_description = expectString(data2.error_description);
  }
...
var convertMap = (map4, options) => Object.entries(map4).reduce((acc, [key, value]) => (acc[key] = convertToNative(value, options), acc), {});
      ...
      if (!isQuery && label === void 0 && data2.Items.length > 0) {
        ...
        return {
          ...
          ...data2.LastEvaluatedKey ? {
            lastKey: `${data2.LastEvaluatedKey.pk.S}:${data2.LastEvaluatedKey.sk.S}`,
            next: () => get2(
              client,
              table,
              keys,
    ...
    return {
      ...
      ...data2.LastEvaluatedKey ? {
        ...
        next: () => scan2(
          client,
          table,
          Object.assign(options, { start: `${data2.LastEvaluatedKey.pk.S}:${data2.LastEvaluatedKey.sk.S}` })
        )
      } : null
    };
  }
...
var set2 = async (client, table, keys, value, opts) => {
  if (Array.isArray(keys)) {
    ...
    if (data2.UnprocessedItems) {
      ...
      return {
        items: batchParams.RequestItems[table].map((x3) => parseResults(x3.PutRequest?.Item, meta, true))
      };
    }
  } else {
...
var _Data = class {
  ...
  constructor(params) {
    ...
    this.client = params.client || new DynamoDBClient(
      Object.assign({ region: this.region }, params.credentials ? { credentials: params.credentials } : null)
    );
  ...
  async set(keys, value, opts) {
    _Data.incrementRequestCount();
    return await set2(this.client, this.table, keys, value, opts);
  }
  async remove(keys) {
    _Data.incrementRequestCount();
